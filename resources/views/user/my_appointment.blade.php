                ...
                <div class="collapse navbar-collapse" id="navbarSupport">
                    <ul class="navbar-nav ml-auto">
                        ...
                        @if (Route::has('login'))
                            @auth
                                <li class="nav-item">
                                    <a class="nav-link" href="contact.html" style="background-color: greenyellow">My
                                        Appointment</a>
                                </li>
                                <li class="nav-item dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                        <!-- Add links or other content related to the authenticated user here -->
                                        <x-dropdown-link href="{{ route('profile.show') }}">
                                            {{ __('Profile') }}
                                        </x-dropdown-link>
                                        @if (Laravel\Jetstream\Jetstream::hasApiFeatures())
                                            <a class="dropdown-item" href="{{ route('api-tokens.index') }}">API
                                                Tokens</a>
                                        @endif
        ...
        <table>
            ...
            <tr style="background-color:black;">
                @foreach ($appoint as $appoints)
                    ...
                    <td><a style="padding:10px;" class="btn btn-danger"
